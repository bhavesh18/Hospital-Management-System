...
import com.app.HospitalManagement.adapter.PatientAdapter;
...
public class PatientList extends AppCompatActivity {
    ...
    ArrayList<PatientListModal> showdata= new ArrayList<>();
...
//        showdata=UtilClass.getArrayListrocode(UtilClass.showdatalist,getApplicationContext());
        ...
        txt_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog alertDialog = new AlertDialog.Builder(PatientList.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(myDb.deleteAllPatData()){
                                    Toast.makeText(PatientList.this,"All Data Deleted", Toast.LENGTH_SHORT).show();
                                    showdata= new ArrayList<>();
                                    viewAll();
                                    setdata();
                                }
                                else{
                                    Toast.makeText(PatientList.this,"Error Occurred", Toast.LENGTH_SHORT).show();
                                }
    ...
    public void setdata()
    {
        adapter = new PatientAdapter(PatientList.this, showdata);
...
//            showMessage("Error","Nothing found");
        ...
        while (res.moveToNext()) {
            PatientListModal resultModal = new PatientListModal(res.getString(0),res.getString(1), res.getString(2), res.getString(3));
